...
const notificationItems: SettingsItem[] = [
  {
    ...
    description: "Daily task reminders and rent alerts by email.",
  },
  {
    key: "smsNotifications",
    label: "SMS notifications",
    description: "Urgent alerts, like gate or security calls, via SMS.",
  },
  {
    key: "marketingEmails",
    label: "Marketing emails",
    description: "Occasional offers and landlord updates.",
  },
  {
    key: "moderationReminders",
    label: "Tenant requests",
    description: "Notify me when a tenant logs a new request or complaint.",
  },
];
...
const CaretakerSettingsPage = () => {
  ...
  return (
    <DashboardShell
      ...
      nav={nav}
      title="Settings"
      subtitle="Manage your profile and how you hear from the landlord."
    >
      <div className="grid gap-6 lg:grid-cols-2">
        <section className="rounded-2xl border border-border bg-card p-6 shadow-soft">
          ...
          <div className="mt-5 flex items-center gap-4">
            ...
            <div>
              <p className="font-display text-lg font-semibold">{user?.name ?? "Caretaker"}</p>
...
export default CaretakerSettingsPage;
